...
This was Near's Stake Wars Challenge 4 and utilizes a package built by eorituz(A Near community member) and more information can be found [here](https://github.com/nearprotocol/stakewars/blob/master/challenges/challenge004.md/)
